...
import de.blogspot.noblenoteandroid.fragments.NoteListFragment
import de.blogspot.noblenoteandroid.fragments.TwoPaneFragment
...
class NoteListController(private var fragment: Fragment, binding: FragmentFileListBinding)
    ...
    init {
        ...
        mCompositeSubscription += recyclerFileAdapter.applyEmptyView(binding.emptyListSwitcher,
            R.id.tv_recycler_view_empty,
            R.id.recycler_view)
        ...
        mCompositeSubscription += app.eventBus.fileSelected.mergeWith(app.eventBus.createFileClick)
                .subscribe { fragment.findNavController().navigate(
                    R.id.editorFragment,
